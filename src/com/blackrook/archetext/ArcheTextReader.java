...
public final class ArcheTextReader
{
	...
	private static class Kernel extends CommonLexerKernel
	{
		...
		static final int TYPE_SEMICOLON = 6;
		static final int TYPE_COLON = 7;
		static final int TYPE_COMMA = 8;
		static final int TYPE_LEFTARROW = 9;

		static final int TYPE_AT = 11;
		static final int TYPE_PLUS = 12;
		static final int TYPE_MINUS = 13;
		static final int TYPE_TIMES = 14;
		static final int TYPE_DIV = 15;
		static final int TYPE_MODULO = 16;
		static final int TYPE_POWER = 17;
		static final int TYPE_LNOT = 18;
		static final int TYPE_NOT = 19;
		static final int TYPE_AND = 20;
		static final int TYPE_OR = 21;
		static final int TYPE_XOR = 22;
		static final int TYPE_LSHIFT = 23;
		static final int TYPE_RSHIFT = 24;
		static final int TYPE_RSHIFTPAD = 25;
